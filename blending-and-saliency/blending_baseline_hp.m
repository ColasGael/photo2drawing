...
%   'im_draw' (3D double array): processed image
    ...
    se1_size = hp.se1_size;
    se2_size = hp.se2_size;
    region_thresh = hp.region_thresh;
    
    im_draw = blending_baseline(im_rgb, thresh, k, n_cluster, gamma, isLAB, level, sigma_color, amplitude, sigma_g, se1_size, se2_size, region_thresh);
end
